...
if ! [[ -f 'MechanicalMastery-Server-r1.5.0.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'MechanicalMastery-Server-r1.5.0.zip' 'https://edge.forgecdn.net/files/4684/136/MechanicalMastery-Server-r1.5.0.zip' || exit 9
	unzip -u -o 'MechanicalMastery-Server-r1.5.0.zip' -d /data
