# [Mechanical Mastery-r1.5.0](https://www.curseforge.com/minecraft/modpacks/mechanical-mastery) on Curseforge
...
The docker on first run will download the same version as tagged of `Mechanical Mastery-r1.5.0` and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
...
* MOTD "Mechanical Mastery-r1.5.0 Server Powered by Docker"
* LEVEL world
...
## Source
Github: https://github.com/Goobaroo/docker-mechanicalmastery

Docker: https://hub.docker.com/repository/docker/goobaroo/mechanicalmastery